...
(function() {
  var AbstractGenerator, Buffer, Callback, Channel, Multicast, Process, Selector, alias, chan, final, fn, go, i, len, mult, name, offer, poll, proc, receive, ref, ref1, select, send, sleep, slice, timeout,
