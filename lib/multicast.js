...
(function() {
  var Generator, Multicast, chan, final, pooled, proc, receive, ref, ref1, send,
  ...
  ref1 = require('./helpers'), pooled = ref1.pooled, Generator = ref1.Generator;
  ...
  module.exports = Multicast = (function() {
    ...
    function Multicast(source) {
      ...
      this.remaining = 0;
      this.completed = chan();
      this.onDelivery = (function(_this) {
    ...
    MulticastGenerator = (function(superClass) {
      ...
      MulticastGenerator.prototype.next = function(value) {
        var channel, id, ref2, ref3, relay;
        while (true) {
          switch (++this._step) {
            case 1:
            ...
            case 2:
              if (final()) {
                ...
                for (id in ref3) {
                  ...
                  send.async(channel, value, this.mult.onDelivery);
                }
                this._step = 0;
                if (this.mult.size > 0) {
