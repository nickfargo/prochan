...
(function() {
  ...
  module.exports = Operation = (function(superClass) {
    ...
    pooled(Operation.Receive = (function(superClass1) {
      ...
      Receive.prototype.execute = function() {
        return this.channel.dequeue(this.selector.process);
      };
    ...
    pooled(Operation.Send = (function(superClass1) {
      ...
      Send.prototype.execute = function() {
        return this.channel.enqueue(this.selector.process, this.value);
      };
