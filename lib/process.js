...
(function() {
  var Channel, Executor, Process, Queue,
  ...
  module.exports = Process = (function(superClass) {
    var BATCH_SIZE, BLOCKED, CRASHED, ERROR, INCIPIENT, NO_OPTIONS, PANICKING, RUNNING, SCHEDULED, TERMINATED, batch, batchId, current, run, runqueue, schedule, table, uid;
    ...
    run = function(p) {
      var done, error, error1, inducer, ref, value;
        ...
        while (true) {
          ...
          switch (value) {
            ...
            case null:
              ...
              break;
            default:
              inducer = 0 && typeof value.then === 'function' ? Channel.fromPromise(value) : value;
              inducer.induce(p);
          }
          if (~p.flags & RUNNING) {
            break;
    ...
    Process.prototype.induce = function(executor) {
    ...
    Process.prototype.detain = function(executor, value) {
      switch (arguments.length) {
        case 1:
          return this._out().detain(executor);
        case 2:
          return this._in().detain(executor, value);
        default:
          throw new Error;
      }
    };

    Process.prototype.cancel = function(operation) {
      switch (operation.type) {
        case 'receive':
          return this._out().cancel(operation);
        case 'send':
          return this._in().cancel(operation);
      }
    };
