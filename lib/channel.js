...
(function() {
  ...
  module.exports = Channel = (function() {
    ...
    function Channel(buffer, transducer) {
      ...
      this.flags = (ref = (ref1 = this.buffer) != null ? ref1.flags : void 0) != null ? ref : EMPTY | FULL;
      this.head = null;
      this.tail = null;
      this.result = void 0;
    }
    ...
    Channel.prototype.induce = function(executor) {
      return this.dequeue(executor);
    };
    ...
    Channel.prototype.close = function(result) {
      ...
      switch (this.flags) {
        ...
        case 13:
          if (this.buffer != null) {
            while (!this.buffer.isEmpty() && this.head) {
    ...
    Channel.prototype.detain = function(executor, value) {
      this.flags |= arguments.length < 2 ? PULLED : PUSHED;
      this.tail = (executor._prev = this.tail) ? this.tail._next = executor : this.head = executor;
      return executor.block(this, value);
    };

    Channel.prototype.dispatch = function(value, isFinal) {
      var executor;
      executor = this.head;
      if (this.head = executor._next) {
        this.head._prev = executor._next = null;
      } else {
        this.tail = null;
        this.flags &= ~(PUSHED | PULLED);
      }
      return executor.proceed(value, isFinal);
    };
    ...
    Channel.prototype.toString = function() {
      ...
      return "[object Channel] {\n  id:     " + this.id + "\n  state:  " + (this.flagsToString()) + "\n  buffer: " + ((ref = (ref1 = this.buffer) != null ? (ref2 = ref1.queue) != null ? ref2.length : void 0 : void 0) != null ? ref : null) + "/" + ((ref3 = (ref4 = this.buffer) != null ? ref4.size : void 0) != null ? ref3 : null) + "\n  head:   " + ((ref5 = (ref6 = (ref7 = this.head) != null ? ref7.id : void 0) != null ? ref6 : (ref8 = this.head) != null ? ref8.constructor.name : void 0) != null ? ref5 : null) + "\n  tail:   " + ((ref9 = (ref10 = (ref11 = this.tail) != null ? ref11.id : void 0) != null ? ref10 : (ref12 = this.tail) != null ? ref12.constructor.name : void 0) != null ? ref9 : null) + "\n}";
    };
